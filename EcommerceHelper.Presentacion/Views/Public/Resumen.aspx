<%@ Page Language="C#"  MasterPageFile="~/Shared/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="Resumen.aspx.cs" Inherits="EcommerceHelper.Presentacion.Views.Public.Resumen" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <div>
   ...
   <br />
     ...
     <h2  style="margin-left:30px">Resumen</h2>
   <br />
   <br />     
   <br />
        <br />
